...
test('portable CLI initializes and recovers a fixture contract', async t => {
  ...
  const contract = fileURLToPath(new URL('../fixtures/learning-contracts/tiny-parser.json', import.meta.url))
  const cli = fileURLToPath(new URL('../bin/ownership.mjs', import.meta.url))
